  ...
  Drupal.responsivePreview = Drupal.responsivePreview || {
      ...
      TabView: Backbone.View.extend({
        ...
        initialize: function (options) {
          ...
          this.listenTo(this.model, 'change:isActive change:dimensions change:activeDevice change:fittingDeviceCount', this.render);
      ...
      PreviewView: Backbone.View.extend({
        ...
        initialize: function (options) {
          ...
          this.listenTo(this.model, 'change:isRotated change:isDetailsExpanded change:dimensions change:activeDevice', this.render);
